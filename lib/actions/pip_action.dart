...
/// and vice-versa.
///
/// TODO: Create implement generic actions on runtime, so plugin users can
/// create theirs own actions without needing to update this preset
///
///
...
///
enum PipAction { play, pause, previous, next, live, none }
